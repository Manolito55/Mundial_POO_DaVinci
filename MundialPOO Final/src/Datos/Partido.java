...
public class Partido {
	...
	public static void MostrarListaPartidos(LinkedList<Partido> lista) {
		...
		for (Partido partido : lista) {
			...
			JOptionPane.showMessageDialog(null,"ID: "+(lista.indexOf(partido)+1)+"\nEquipo 1: " + partido.getTeam1().getNombre()+" - "+ "Goles: "+ partido.getGoles1()+"\nEquipo 2: "+ partido.getTeam2().getNombre()+" - "+ "Goles: "+partido.getGoles2()+"\nDuracion del Partido: "+partido.getDuracion());
	...
	public static void CargarPartidosManual32(LinkedList<Pais>paises,LinkedList<Partido>partidos) {
		...
		partidos.add(Encargado.JugarPartidoManual(paises.get(0),paises.get(1)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(2),paises.get(3)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(0),paises.get(2)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(3),paises.get(1)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(3),paises.get(0)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(1),paises.get(2)));
		
		//Grupo B
		
		partidos.add(Encargado.JugarPartidoManual(paises.get(4),paises.get(5)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(6),paises.get(7)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(4),paises.get(6)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(7),paises.get(5)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(7),paises.get(4)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(5),paises.get(6)));
		
		//Grupo C
		
		partidos.add(Encargado.JugarPartidoManual(paises.get(8),paises.get(9)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(10),paises.get(11)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(8),paises.get(10)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(11),paises.get(9)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(11),paises.get(8)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(9),paises.get(10)));
		
		//Grupo D
		
		partidos.add(Encargado.JugarPartidoManual(paises.get(12),paises.get(13)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(14),paises.get(15)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(12),paises.get(14)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(15),paises.get(13)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(15),paises.get(12)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(13),paises.get(14)));
		
		//Grupo E
		
		partidos.add(Encargado.JugarPartidoManual(paises.get(16),paises.get(17)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(18),paises.get(19)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(16),paises.get(18)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(19),paises.get(17)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(19),paises.get(16)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(17),paises.get(18)));
		
		//Grupo F
		
		partidos.add(Encargado.JugarPartidoManual(paises.get(20),paises.get(21)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(22),paises.get(23)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(20),paises.get(22)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(23),paises.get(21)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(23),paises.get(20)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(21),paises.get(22)));
		
		//Grupo G
		
		partidos.add(Encargado.JugarPartidoManual(paises.get(24),paises.get(25)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(26),paises.get(27)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(24),paises.get(26)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(27),paises.get(25)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(27),paises.get(24)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(25),paises.get(26)));
		
		//Grupo H
		
		partidos.add(Encargado.JugarPartidoManual(paises.get(28),paises.get(29)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(30),paises.get(31)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(28),paises.get(30)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(31),paises.get(29)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(31),paises.get(28)));
		partidos.add(Encargado.JugarPartidoManual(paises.get(29),paises.get(30)));
