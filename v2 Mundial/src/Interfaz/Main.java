...
public static void MostrarListaPartidos(LinkedList<Partido> lista) {
		...
		for (Partido partido : lista) {
			System.out.println("Equipo 1: "+ partido.getTeam1()+" - "+ "Equipo 2: "+partido.getTeam2());
			System.out.println("Goles Equipo 1: "+ partido.getGoles1()+" - "+ "Goles Equipo 2: "+partido.getGoles2());
